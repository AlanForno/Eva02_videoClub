...
//_________________________________________________________________________________________________________//
	...
	public void queNoMePermitaAlquilarAUnClienteBasicoMenorDeLaEdadParaLaPelicula() {
		...
		Pelicula tarzan = new Pelicula("Tarzan", 1, 200.0, 18); // la pelicula es para mayores de 18 a�os
		mania.agregarPelicula(1, tarzan);

		Cliente carlos = new ClienteMedio("cris", 1, 12, 1000.0);// carlos tiene 12 a�os.
	...
	public void queNoLePermitaAUnClienteBasicoTenerMasDeCincoPeliculas() {
		...
		Pelicula pelicula1= new Pelicula("peli", 4, 50.0,18);
		mania.agregarPelicula(1,pelicula1);
		assertTrue(mania.alquilarPelicula(2,cris,pelicula1));


		Pelicula pelicula2= new Pelicula("peli2", 5, 50.0,18);
		mania.agregarPelicula(1, pelicula2);
		assertTrue(mania.alquilarPelicula(2,cris,pelicula2));
